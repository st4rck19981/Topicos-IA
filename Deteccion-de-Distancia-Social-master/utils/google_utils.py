...
def attempt_download(weights):
    ...
    msg = weights + ' missing, try downloading from https://drive.google.com/file/d/14Y-rd6csihfs5igpnsRd3Vrg3vuBMztR/view?usp=sharing'

    r = 1
    if len(weights) > 0 and not os.path.isfile(weights):
        d = {'yolov3-spp.pt': '',  # yolov3-spp.yaml
